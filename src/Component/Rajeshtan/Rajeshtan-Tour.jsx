    ...
    <div>
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            Morning: Fly from Delhi to Jaipur and be met and transferred to your hotel.
            Afternoon: This tour has to include the visit to the City Palace and
            Jantar Mantar. Evening: Spend some time walking around the local
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            ...
            elephants or jeeps to the palace. Afternoon: Get to tour around the
            tourists’ attractions such as Hawa Mahal or the Palace of Winds and
            the Jal Mahal or Water Palace. Evening: Experience an authentic
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            ...
            to Jodhpur approximately 250 K. M which takes 5-6 hours. Afternoon:
            Retire to your hotel of the day to freshen up. Evening: Clock tower:
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            Morning: Explore Mehrangarh Fort and Jaswant Thada. Afternoon: Visit
            Umaid Bhawan Palace and the surrounding gardens. Evening: Stroll
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            ...
            road). Alternatively, you can take a flight if available. Afternoon:
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            Morning: Visit the City Palace and the Crystal Gallery. Afternoon:
            Explore Jagdish Temple and the Saheliyon ki Bari (Garden of the
            Maidens). Evening: Enjoy a cultural show and dinner at a local
            restaurant or hotel.
          </p>
        </div>
        <div className="w-full md:w-1/2 flex justify-start md:justify-end ">
      ...
      <div className="flex flex-wrap justify-center mt-10 mx-5">
        <div className="w-full md:w-1/2">
          ...
          <p className="font-normal text-gray-900 lato-bold">
            ...
            time for last-minute shopping or sightseeing. Afternoon: Transfer to
