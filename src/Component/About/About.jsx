    ...
    <div>
      ...
      <div className='flex justify-center items-top gap-10 md:flex-row flex-col'>
        ...
        <div className='md:'>
          ...
          <p className='font-normal text-gray-700 lato-bold'>Saffron Routes specializes in and believes in personalized travel and tour solutions as its services are as diverse as the country of India. Our aim is to present India as cleanly, uniquely, and as accurately as possible. Our aim is to guide you through all the opportunities of this land, from the grandeur of the forts and the richness of the colourful civilizations to the quietude of the landscape and the wisdom of the retreats. Thousands of tourists can testify that Africa marathon, Silk Road, photographing wild tigers are unique and that we ensure just that. Being well aware of what every visitor would like to get and our commitment of trying to go beyond and above their expectation, we provide Quality and Excellence.</p>
          <h1 className='text-2xl playfair font-bold tracking-tight text-gray-900'>Our Services:</h1>
          <p className='font-normal text-gray-700 lato-bold'>Saffron Routes boasts of having the capability to execute such plans accurately has assembled a vast array of option that it offers activity-based tours suit individual and group travelers. Our services encompass cultural touring, adventure travel, history and archaeology, art and craft, heritage travel in India, wildlife tourism, spiritual travel and pilgrimage, wellness and holistic tourism, Yoga and meditation tourism, and many other forms of travel across the Indian sub continent. We are primarily involved in the sale of inbound tours across the Northern region of India. Among our principal offerings are:Among our principal offerings are:</p>
          ...
          <p className='font-normal text-gray-700 lato-bold'>Saffron Routes boasts the service of developing the unique travel schedule. All you need to tell us is your dates to travel, the duration, and how much you’d be willing to spend, and we will take care of the rest to make your travel a remarkable one.</p>
