...
function GoldenTri() {
  ...
  <img src={GoldenTriangle} alt="" className="h-72 w-full  brightness-50" />
  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-lg">
    ...
    <p className="text-center lato-regular text-3xl">4-night, 5-day </p>
      ...
      <div>
        ...
        <h1 className="text-2xl playfair  font-bold tracking-tight text-gray-900 dark:text-white">Day 1: Arrival in Delhi</h1>
        <p className="font-normal text-gray-900 lato-bold">
          ...
          Connaught Place or visit the lively market at Chandni Chowk.
